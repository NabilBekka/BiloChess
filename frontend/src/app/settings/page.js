    ...
    <main>
      ...
      <div className={styles.container}>
        ...
        <form className={styles.card} onSubmit={handleUpdate}>
          ...
          <div className={styles.formGroup}>
            ...
            <PasswordInput value={form.newPassword} onChange={(e) => setForm({ ...form, newPassword: e.target.value })} placeholder="Laisser vide pour ne pas changer" />
          </div>
          <hr className={styles.divider} />
          <div className={styles.formGroup}>
            <label>Mot de passe actuel (requis)</label>
            <PasswordInput value={form.currentPassword} onChange={(e) => setForm({ ...form, currentPassword: e.target.value })} placeholder="Votre mot de passe actuel" required />
        ...
        <div className={`${styles.card} ${styles.dangerCard}`}>
          ...
          <button type="button" className={styles.deleteBtn} onClick={() => setShowDeleteAccount(true)}>
      ...
      {showDeleteAccount && (
        <DeleteAccountModal
          ...
          onForgotPassword={() => { setShowDeleteAccount(false); setShowForgotPassword(true); }}
